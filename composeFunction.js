...
/*
function, compose with parameter functions
return a new function that takes an integer x
loop through the functions array in reverse order
apply each function to x
